...
download_civit_model 575495 "$MODEL_DIR"
download_civit_model 1295881 "$MODEL_DIR"
download_civit_model 826474 "$MODEL_DIR"

# Download LoRAs - NO HARDCODED NAMES, all from API
echo "=== Downloading LoRAs ==="
download_civit_model 1321398 "$LORA_DIR"
download_civit_model 809420 "$LORA_DIR"
download_civit_model 791655 "$LORA_DIR"
download_civit_model 947425 "$LORA_DIR"
download_civit_model 515222 "$LORA_DIR"
download_civit_model 623539 "$LORA_DIR"
download_civit_model 918061 "$LORA_DIR"
download_civit_model 677489 "$LORA_DIR"
download_civit_model 365153 "$LORA_DIR"
download_civit_model 717828 "$LORA_DIR"
download_civit_model 419233 "$LORA_DIR"
download_civit_model 1158949 "$LORA_DIR"
download_civit_model 382152 "$LORA_DIR"
download_civit_model 449738 "$LORA_DIR"
download_civit_model 861120 "$LORA_DIR"
download_civit_model 814903 "$LORA_DIR"
download_civit_model 608729 "$LORA_DIR"

# Verify all models and LoRAs are installed
echo "=== Verifying model installations ==="
for model_id in 575495 1295881 826474; do
  check_model_installed "$model_id" "$MODEL_DIR"
done

echo "=== Verifying LoRA installations ==="
for lora_id in 1321398 809420 791655 947425 515222 623539 918061 677489 365153 717828 419233 1158949 382152 449738 861120 814903 608729; do
